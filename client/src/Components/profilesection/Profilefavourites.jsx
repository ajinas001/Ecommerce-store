...
import Aos from 'aos';
import { removeFrowishlist } from '../../Redux/WishSlice';
    ...
    <>
      ...
      <div className="font-sans bg-white md:px-24 px-8 py-8">
        <div className="flex max-sm:flex-col gap-4 h-auto">
          ...
          {/* Main content */}
          <div className="max-w-4xl mx-auto w-full h-max rounded-md p-8 sticky top-0 mt-0" data-aos="fade-left">
          <section className="h-screen w-full  bg-white py-12 sm:py-16 lg:py-10" data-aos="fade-up">
